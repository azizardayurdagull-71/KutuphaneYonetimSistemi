...
// Eğer filtrelerden biri bile doluysa arama yap, değilse hepsini getir
...
<div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
    ...
    <div class="alert alert-success alert-dismissible fade show shadow-sm border-0 mb-4" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div>
                <strong>Başarılı!</strong> <?php echo htmlspecialchars($_GET['success']); ?>
            </div>
        </div>
        ...
        <form method="GET" id="searchForm" class="row g-3">
            ...
            <div class="col-md-2">
                ...
                <select name="category" class="form-select">
                    <option value="">Tümü</option>
                    <option value="Roman" <?php echo $filters['category'] == 'Roman' ? 'selected' : ''; ?>>Roman</option>
                    <option value="Bilim" <?php echo $filters['category'] == 'Bilim' ? 'selected' : ''; ?>>Bilim</option>
                    <option value="Dergi" <?php echo $filters['category'] == 'Dergi' ? 'selected' : ''; ?>>Dergi</option>
                    <option value="Tarih" <?php echo $filters['category'] == 'Tarih' ? 'selected' : ''; ?>>Tarih</option>
                    <option value="Gezi" <?php echo $filters['category'] == 'Gezi' ? 'selected' : ''; ?>>Gezi</option>
                    <option value="Genel" <?php echo $filters['category'] == 'Genel' ? 'selected' : ''; ?>>Genel</option>
                </select>
            </div>
            ...
            <div class="col-md-2">
                ...
                <select name="sort" class="form-select">
                    ...
                    <option value="title_asc" <?php echo ($filters['sort'] == 'title_asc') ? 'selected' : ''; ?>>A-Z (Kitap Adı)</option>
                    <option value="title_desc" <?php echo ($filters['sort'] == 'title_desc') ? 'selected' : ''; ?>>Z-A (Kitap Adı)</option>
                    <option value="author_asc" <?php echo ($filters['sort'] == 'author_asc') ? 'selected' : ''; ?>>A-Z (Yazar Adı)</option>
                    <option value="author_desc" <?php echo ($filters['sort'] == 'author_desc') ? 'selected' : ''; ?>>Z-A (Yazar Adı)</option>
                </select>
            </div>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-muted" style="font-size: 0.75rem;">ISBN: <?php echo htmlspecialchars($book['isbn']); ?></div>
                            </td>
                            <td>
                            ...
                            <td class="text-end pe-4">
                                <div class="btn-group shadow-sm">
                                    <a href="book_details.php?id=<?php echo $book['id']; ?>" class="btn btn-sm btn-white border" title="Detaylar">
                                        <i class="bi bi-eye-fill text-info"></i>
                                    </a>
                                    
                                    <?php if ($_SESSION['role'] !== 'admin'): ?>
                                        <a href="borrow_action.php?id=<?php echo $book['id']; ?>" class="btn btn-primary btn-sm">
                                            <i class="bi bi-plus-circle me-1"></i> Ödünç Al
                                        </a>
                                    <?php endif; ?>
